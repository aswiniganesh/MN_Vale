...
function showMessage(response) {
  ...
  if (response === "No") {
    ...
    //document.getElementsByClassName("image")[0].src = "images/aswini_no_devil.jpg";
  ...
  if (response === "Yes") {
    ...
    document.getElementById('giftCards').style.display = 'flex';
    ...
    audioElement.src = "./images/final_video.mp4"; // Source of the sound
    ...
    yesMessage.textContent = "Happy Valentine's day baby kutty :)";
    yesMessage.style.display = "block";
    yesMessage.style.fontStyle = "normal";
    //document.getElementsByClassName("final")[0].src = "images/final_video.mp4";
